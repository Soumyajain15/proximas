...
export default function LandingPage() {
  ...
  const getStartedLink = () => {
    if (!isFirebaseReady || isLoading) return "#"; // Or disable button
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-background to-secondary p-6 text-center selection:bg-primary/20 selection:text-primary">
      ...
      {(!isFirebaseReady || isLoading) ? (
         <Button size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 shadow-lg hover:shadow-xl transition-shadow duration-300" disabled>
